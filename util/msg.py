...
def GetBuyEditMsg(name):
    return {
        ...
        "tocountry_is_invalid": "Указана страна доставки, отсутствующая в базе данных",
...
def GetSaleAddMsg(name):
    return {
        "fromdate_is_empty": "Поле с датой отправления обязательно для заполнения",
        "fromdate_is_invalid": "Поле с датой отправления должно быть в формате дд.мм.гггг",
        "fromcountry_is_empty": "Поле со страной отправления обязательно для заполнения",
        "fromcountry_is_invalid": "Указана страна отправления, отсутствующая в базе данных",
        "todate_is_empty": "Поле с датой прибытия обязательно для заполнения",
